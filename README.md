...
```javascript
// Basic Information
valentineName: "Adam"                    // Your Valentine's name
...
// Love Meter Messages
loveMessages: {
    extreme: "omg?? 😛😛😛MY MAN LOVES MEEEE",  // Shows above 5000%
    high: "u want ur dick sucked huh",              // Shows above 1000%
    normal: "okay ur a little cheap with it but thats okay.."                           // Shows above 100%
}

// Final Celebration
celebration: {
    title: "i love you<3",     // Celebration title
    message: "now come get your gift (hole)...",          // Celebration message
