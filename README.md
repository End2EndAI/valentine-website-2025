...
```javascript
// Basic Information
valentineName: "Suchi"                    // Your Valentine's name
...
celebration: {
    ...
    message: "Happppyyy Valentines Day BAbeeeeeeeeeeeeeee ahhhhhh udaaaaaa heigali chadiphatigalaaaaaa",          // Celebration message
